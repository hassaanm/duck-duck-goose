defmodule BirdWatcherWeb.Router do
  use BirdWatcherWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {BirdWatcherWeb.Layouts, :root}
  ...
  if Application.compile_env(:bird_watcher, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: BirdWatcherWeb.Telemetry
